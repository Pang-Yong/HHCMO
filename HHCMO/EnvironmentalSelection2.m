function Next = EnvironmentalSelection2(all_Obj,eCon,ineCon,N,Z,Zmin)
% The environmental selection of NSGA-III with both EC and IC
...
%--------------------------------------------------------------------------
    ...
    Choose = LastSelection(all_Obj(Next,:),all_Obj(Last,:),N-sum(Next),Z,Zmin);
